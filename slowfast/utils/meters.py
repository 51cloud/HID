    ...
    def finalize_metrics(self, ks=(1, 3)):
        ...
        if self.multi_label:
            ...
            num_topks_correct = metrics.topks_correct(
                self.video_preds, self.video_labels, (1, 3)
            )
            topks = [
...
class TrainMeter(object):
    ...
    def __init__(self, epoch_iters, cfg):
        ...
        self.mb_top3_err = ScalarMeter(cfg.LOG_PERIOD)
    ...
    def update_stats(self, top1_err, top3_err, loss, lr, mb_size):
        """
        Update the current stats.
        Args:
        ...
        if not self._cfg.DATA.MULTI_LABEL:
            ...
            self.mb_top3_err.add_value(top3_err)
            # Aggregate stats
            self.num_top1_mis += top1_err * mb_size
            self.num_top3_mis += top3_err * mb_size
    ...
    def log_iter_stats(self, cur_epoch, cur_iter):
        ...
        if not self._cfg.DATA.MULTI_LABEL:
            ...
            stats["top3_err"] = self.mb_top3_err.get_win_median()
        logging.log_json_stats(stats)
    ...
    def log_epoch_stats(self, cur_epoch):
        ...
        if not self._cfg.DATA.MULTI_LABEL:
            ...
            top3_err = self.num_top3_mis / self.num_samples
            avg_loss = self.loss_total / self.num_samples
            stats["top1_err"] = top1_err
            stats["top3_err"] = top3_err
            stats["loss"] = avg_loss
        logging.log_json_stats(stats)
...
class ValMeter(object):
    ...
    def update_stats(self, top1_err, top3_err, mb_size):
        """
        Update the current stats.
        Args:
            top1_err (float): top1 error rate.
    ...
    def log_epoch_stats(self, cur_epoch):
        ...
        if self._cfg.DATA.MULTI_LABEL:
            ...
            self.min_top3_err = min(self.min_top3_err, top3_err)

            stats["top1_err"] = top1_err
            stats["top3_err"] = top3_err
            stats["min_top1_err"] = self.min_top1_err
            stats["min_top3_err"] = self.min_top3_err
