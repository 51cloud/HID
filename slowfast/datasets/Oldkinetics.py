...
class Oldkinetics(torch.utils.data.Dataset):
    """
    ...
    def _construct_loader(self):
        ...
        path_to_file = os.path.join(
            self.cfg.DATA.OLD_PATH_TO_DATA_DIR, "{}.csv".format(self.mode)
        )
    ...
    def __getitem__(self, index):
        ...
        for i_try in range(self._num_retries):
            ...
            if self.mode in ["train"]:
                ...
                label = self._labels[index]
                frames = utils.pack_pathway_output(self.cfg, frames1, frames1, frames1)
