...
# def pack_pathway_output(cfg, frames, frames2, frames3):
#     """
#     Prepare output as a list of tensors. Each tensor corresponding to a
#     unique pathway.
#     Args:
...
#         frames3 = frames3[[2, 1, 0], :, :, :]
#     if cfg.MODEL.ARCH in cfg.MODEL.SINGLE_PATHWAY_ARCH:
#         # print('1111111111111111111111')
#         frame_list = [frames, frames2, frames3]
#
#     elif cfg.MODEL.ARCH in cfg.MODEL.MULTI_PATHWAY_ARCH:
#         # print('222222222222222222222')
#         fast_pathway = frames
#         fast_pathway2 = frames2
#         fast_pathway3 = frames3
#         # Perform temporal sampling from the fast pathway.
#         slow_pathway = torch.index_select(
#             frames,
#             1,
...
#             ).long(),
#         )
#         slow_pathway3 = torch.index_select(
#             frames3,
#             1,
#             torch.linspace(
#                 0, frames3.shape[1] - 1, frames3.shape[1] // cfg.SLOWFAST.ALPHA
#             ).long(),
#         )
#         frames_list1 = [slow_pathway, fast_pathway]
#         frames_list2 = [slow_pathway2, fast_pathway2]
#         frames_list3 = [slow_pathway3, fast_pathway3]
#         frame_list = [frames_list1, frames_list2, frames_list3]
#     else:
#         raise NotImplementedError(
#             "Model arch {} is not in {}".format(
#                 cfg.MODEL.ARCH,
...
def tensor_normalize(tensor, mean, std):
    ...
    if type(mean) == list:
        ...
        # print('22222222222222222222222222222222222', mean)
    if type(std) == list:
        std = torch.tensor(std)
        # print('3333333333333333333333333333333333333333', std)
    tensor = tensor - mean
    tensor = tensor / std
    return tensor
