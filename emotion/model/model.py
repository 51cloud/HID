...
class Mini_Xception(nn.Module):
    def __init__(self):
        ...
        # self.conv2 = conv_bn_relu(8, 8, kernel_size=3, stride=4, padding=1)
        self.residual_blocks = nn.ModuleList([
        ...
        # self.conv3 = nn.Conv2d(128, 2048, kernel_size=3, stride=1, padding=1)
        # self.conv3 = nn.Conv2d(128, 2048, kernel_size=3, stride=2, padding=0)
...
class Change_Size(nn.Module):
    def __init__(self):
        super(Change_Size, self).__init__()
        self.conv1 = conv_bn_relu(7, 1024, kernel_size=3, stride=3, padding=1)
