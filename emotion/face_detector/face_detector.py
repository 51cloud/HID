...
class HaarCascadeDetector(FaceDetectorIface):
    def __init__(self, root=None):
        self.path = "/public/home/zhouz/perl5/HAR/emotion/face_detector/haarcascade_frontalface_default.xml"
        if root:
...
class DnnDetector(FaceDetectorIface):
    ...
    """
    def __init__(self, root=None):
        self.prototxt = "/public/home/zhouz/perl5/HAR/emotion/face_detector/deploy.prototxt.txt"
        self.model_weights = "/public/home/zhouz/perl5/HAR/emotion/face_detector/res10_300x300_ssd_iter_140000.caffemodel"
